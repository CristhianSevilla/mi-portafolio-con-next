...
import styles from "../styles/barraRedes.module.css"
            ...
            <ul className={styles.redesicono}>
                ...
                <li>
                    <Link className={styles.icono} href="mailto:crissev17@gmail.com" aria-label="Email" target="_blank" rel="noreferrer">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
                ...
                <li>
                    <Link className={styles.icono} href="https://www.linkedin.com/in/cristhiansevilla" aria-label="Linkedin" target="_blank" rel="noreferrer">
                ...
                <li>
                    <Link className={styles.icono} href="https://github.com/CristhianSevilla" aria-label="GitHub" target="_blank" rel="noreferrer">
