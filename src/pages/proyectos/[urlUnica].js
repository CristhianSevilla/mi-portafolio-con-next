...
const Proyecto = () => {
  ...
  const proyectos = PROYECTOS.filter(
    (proyecto) => proyecto.urlUnica === query.urlUnica
  );
      ...
      <section className={styles.proyectoportafolio}>
        <div className="contenedor-small">
          <div className={styles.tituloportafolio}>
            <h1>{titulo}</h1>
            <p>
              {tipoProyecto.uno} <span>{tipoProyecto.dos}</span>
            </p>
          </div>
          <div className={styles.heroimage}>
            <div className={styles.sombraimagen}></div>
            {proyecto && urlFondo ? (
              <Image
                src={`/imagenes/projects${urlFondo}`}
                width={1000}
                height={1000}
                alt={`Proyecto ${titulo}`}
                quality={100}
          ...
          <div className="texto">
            <h2 className="my-div">
              {t(`${proyecto?.urlUnica}.about`) || "Acerca del proyecto"}
            </h2>

            <p className="font-size-big">
              {t(`${proyecto?.urlUnica}.description1`) || acerca1}
            </p>
          ...
          <div
            className={`${styles.imagenesgrid} ${styles.proyectocontenedorimagen} elemento-animado`}
          >
            {proyecto && imgIphone1 ? (
              <Image
                src={`/imagenes/projects${imgIphone1}`}
                width={1000}
                height={1000}
                alt={`Proyecto ${titulo} en un teléfono`}
                quality={100}
              />
            ) : null}
            ...
            {proyecto && imgIphone2 ? (
              <Image
                src={`/imagenes/projects${imgIphone2}`}
                width={1000}
                height={1000}
                alt={`Proyecto ${titulo} en un teléfono`}
                quality={100}
          ...
          <div className="texto">
            <p className="font-size-big">
              {t(`${proyecto?.urlUnica}.description3`) || acerca3}
            </p>

            <div
              className={`${styles.proyectocontenedorimagen} elemento-animado`}
            >
              {proyecto && imgMac ? (
                <Image
                  src={`/imagenes/projects${imgMac}`}
                  width={1000}
                  height={1000}
                  alt={`Proyecto ${titulo} en una macbook`}
                  quality={100}
                />
              ) : null}
            </div>
            ...
            <div className="contenedorbotones elemento-animado">
              {urlweb && (
                <Link
                  ...
                  target="_blank"
                >
                  {t(`${proyecto?.urlUnica}.viewWebsite`) || "Ver Sitio Web"}
                </Link>
              )}
            </div>
          </div>
          <div className="Stack-proyecto descripcion-proyecto-portafolio">
            <div className="texto">
              <h2>
                {t(`${proyecto?.urlUnica}.stack`) || "Stack del proyecto"}
              </h2>

              <p className="font-size-big">
                {t(`${proyecto?.urlUnica}.stackDescription`) || stack}
              </p>
            ...
            >
              {proyecto && imgMacIphone ? (
                <Image
                  src={`/imagenes/projects${imgMacIphone}`}
                  width={1000}
                  height={1000}
                  alt={`Proyecto ${titulo} diseño responsivo`}
                  quality={100}
                />
              ) : null}
            </div>
            <div className="contenedorbotones elemento-animado">
              <Link
                ...
                target="_blank"
              >
                {t(`${proyecto?.urlUnica}.viewCode`) || "Ver Código"}
              </Link>
            </div>
          </div>
        </div>
